package com.martin.trendingmovie.features.search
...
import com.martin.trendingmovie.convertToTrendingShowFromSearchResponse
...
class SearchViewModel @Inject constructor(
    ...
    private val _searchedTvShows: MutableStateFlow<PagingData<TrendingTvShowsTable>> = MutableStateFlow(PagingData.empty())
    ...
    fun searchHeroes(query: String) {
        viewModelScope.launch {
            repository.searchTvShows(tvShowName = query).cachedIn(viewModelScope).collect { movies ->
