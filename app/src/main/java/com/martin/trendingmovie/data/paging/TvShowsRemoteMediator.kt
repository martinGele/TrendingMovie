package com.martin.trendingmovie.data.paging
...
import com.martin.trendingmovie.BuildConfig
import com.martin.trendingmovie.Constants.NO_INFO
import com.martin.trendingmovie.convertToTrendingShowFromResponse
...
class TvShowsRemoteMediator(
    ...
    override suspend fun load(
        ...
        return try {
            ...
            val response = moviesApi.getTrendingTvShows(apiKey = BuildConfig.MOVIES_ACCESS_KEY, language = "en", page = currentPage)
