package com.martin.trendingmovie
...
import com.martin.trendingmovie.data.remote.models.TrendingMoviesResponse

fun convertToTrendingTvShow(favoriteTvShow: FavoritesTable): TrendingTvShowsTable {
    return TrendingTvShowsTable(favoriteTvShow.favoriteId,
...
fun convertToTrendingShowFromResponse(trendingTvShows: TrendingMoviesResponse.Result?, page: Int?): TrendingTvShowsTable {
